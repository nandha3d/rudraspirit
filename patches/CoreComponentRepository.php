 ...
 *
 * The original vendor class phoned home to activation.activeitzone.com and, on a
 * "bad" response, redirected the whole app to https://activeitzone.com/activation/
 * (the purchase-code wizard) — which fired on login/admin pages. All methods are
