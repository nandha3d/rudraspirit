    ...
    public function step0(Request $request)
    {
        ...
        if ($request->has('update_zip')) {
            if (class_exists('ZipArchive')) {
                ...
                //COMMENT FOR DEMO->
                $versions = ['10.1.0'=>'v1010.sql','10.2.0'=>'v1020.sql','10.2.1'=>'v1021.sql','10.2.2'=>'v1022.sql','10.3.0'=>'v1030.sql','10.4.0'=>'v1040.sql','10.4.1'=>'v1041.sql','10.4.2'=>'v1042.sql','10.4.3'=>'v1043.sql','10.5.0'=>'v1050.sql','10.5.1'=>'v1051.sql','10.6.0'=>'v1060.sql','10.7.0'=>'v1070.sql','10.8.0'=>'v1080.sql'];

                $keys = array_keys($versions);
                $current_version = (get_setting('current_version') != null) ? get_setting('current_version') : '10.1.0';
