...
@section('panel_content')
    <div class="row">
        ...
        @if (get_setting('dispute_refund_request_time') > 0)
            <div class="col-sm-6 col-md-6 col-lg-6 mb-4">
                <div class="card shadow-none h-460px mb-0 h-100">
                    <div class="card-body pb-5">
                        <div class="card-title text-primary fs-16 fw-600">
                            {{ translate('Dispute Refund Days') }}
                        </div>
                        <hr>
                        <ul class="list-group">
                            <li class="d-flex justify-content-between align-items-center my-2 text-primary fs-13">
                                {{ translate('Dispute Refund time : ') . ' ' . get_setting('dispute_refund_request_time') . ' ' . translate('days.') }}
                            </li>
                        </ul>
                    </div>
                </div>
